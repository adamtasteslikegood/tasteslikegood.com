...
class DebtDashboard:
    ...
    def _generate_executive_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_debt_items": (
                self.processed_snapshots[-1]["total_debt_items"] if self.processed_snapshots else 0
            ),
            "estimated_effort_hours": (
                self.processed_snapshots[-1]["total_effort_estimate"]
                if self.processed_snapshots
                else 0
            ),
            "high_priority_items": (
                self.processed_snapshots[-1]["high_priority_count"]
                if self.processed_snapshots
                else 0
            ),
