...
class LicenseChecker:
    ...
    def analyze_project(
        self, project_path: str, dependency_inventory: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    def _detect_license_conflicts(
        self, project_license: Optional[str], dependencies: List[DependencyLicense]
            ...
            serializable_results["dependencies"] = [
                {
                    ...
                    "license_detected": (
                        asdict(dep.license_detected) if dep.license_detected else None
                    ),
